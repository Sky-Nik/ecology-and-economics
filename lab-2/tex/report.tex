...
\begin{minipage}[t]{.5\textwidth}
	\begin{figure}[H]
		...
		\includegraphics[width=\textwidth]{phase_square.png}
	\end{figure}
\end{minipage}
\begin{minipage}[t]{.5\textwidth}
	\begin{figure}[H]
		...
		\includegraphics[width=\textwidth]{phase_focus.png}
	\end{figure}
\end{minipage}
...
\begin{figure}[H]
	\centering
	\caption{$x(0) < y(0)$}
	\includegraphics[width=\textwidth]{plot_2d_4_6.png}
\end{figure}

\begin{figure}[H]
	\centering
	\caption{$x(0) > y(0)$}
	\includegraphics[width=\textwidth]{plot_2d_8_2.png}
\end{figure}
...
\begin{minipage}[t]{.5\textwidth}
	\begin{figure}[H]
		\centering
		\caption{$x(0) < y(0)$}
		\includegraphics[width=\textwidth]{plot_3d_4_6.png}
	\end{figure}
\end{minipage}
\begin{minipage}[t]{.5\textwidth}
	\begin{figure}[H]
		\centering
		\caption{$x(0) > y(0)$}
		\includegraphics[width=\textwidth]{plot_3d_8_2.png}
	\end{figure}
\end{minipage}
...
\begin{minipage}[t]{.5\textwidth}
	\begin{figure}[H]
		\centering
		\caption{На квадраті $[0, 1] \times [0, 1]$}
		\includegraphics[width=\textwidth]{phase_square_2.png}
	\end{figure}
\end{minipage}
\begin{minipage}[t]{.5\textwidth}
	\begin{figure}[H]
		\centering
		\caption{В околі стаціонарної точки}
		\includegraphics[width=\textwidth]{phase_focus_2.png}
	\end{figure}
\end{minipage}
...
\begin{figure}[H]
	\centering
	\caption{$x(0) < y(0)$}
	\includegraphics[width=\textwidth]{plot_2d_1_9_2.png}
\end{figure}

\begin{figure}[H]
	\centering
	\caption{$x(0) > y(0)$}
	\includegraphics[width=\textwidth]{plot_2d_9_1_2.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\caption{$x(0) < y(0)$}
	\includegraphics[width=\textwidth]{plot_3d_1_9_2.png}
\end{figure}
\end{minipage}
\begin{minipage}[t]{.5\textwidth}
\begin{figure}[H]
	\centering
	\caption{$x(0) > y(0)$}
	\includegraphics[width=\textwidth]{plot_3d_9_1_2.png}
\end{figure}
\end{minipage}
