...
15. **Еластичність попиту та пропозиції. Три типи рівноваги ринку.**
    ...
    * $$\left|E_d^p\right| < 1$$ &mdash; попит називається не еластичним;
    * $$\left|E_d^p\right| = 1$$ &mdash; попит називається еластичним;
    * $$\left|E_d^p\right| > 1$$ &mdash; попит називається наделастичним.
    ...
    * $$\left|E_s^p\right| < 1$$ &mdash; пропозиція називається не еластичною;
    * $$\left|E_s^p\right| = 1$$ &mdash; пропозиція називається еластичною;
    * $$\left|E_s^p\right| > 1$$ &mdash; пропозиція називається наделастичною.

    На базі еластичностей можна проводити аналіз стабільності рівноваги:

    * $$\left|E_d\right| > E_s$$ &mdash; стабільна динамічна рівновага;
    * $$\left|E_d\right| = E_s$$ &mdash; квазістабільна динамічна рівновага;
    * $$\left|E_d\right| < E_s$$ &mdash; не стабільна динамічна рівновага.
