...
4. **Модель Вольтерра. Постановка. Типи стаціонарних точок.**
   ...
   \left\{
   \begin{align*}
   \frac{\mathrm{d}x}{\mathrm{d}t} &= \epsilon_1 \cdot x - \gamma_1 \cdot x \cdot y, \\
   \frac{\mathrm{d}y}{\mathrm{d}t} &= - \epsilon_2 \cdot y + \gamma_2 \cdot x \cdot y,
   \end{align*}
   \right.
   $$
   ...
   - $$\epsilon_1$$ &mdash; швидкість розмноження жертви за відсутності хижака;
   - $$\epsilon_2$$ &mdash; смертність хижака за відсутності жертви;
   ...
   2. $$(x^\star, y^\star) = \left( \frac{\epsilon_2}{\gamma_2}, \frac{\epsilon_1}{\gamma_1} \right) &mdash; нетривільна сідлова точка, її детальніше дослідження показує, що вона є _центром_ .
