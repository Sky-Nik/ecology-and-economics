...
3. $$(x^\star, y^\star) = \left( \frac{\varepsilon_2}{\gamma_2}, \frac{\varepsilon_1 \gamma_2 
	- \beta_1 \varepsilon_2}{\gamma_1 \gamma_2} \right)$$ &mdash; нетривільна стаціонарна 
	точка, її детальніше дослідження показує, що вона є _стійким вузлом_ , _виродженим стійким 
	вузлом_ , або _стійким фокусом_ , залежно від значень
