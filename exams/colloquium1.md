...
3. **Модель Леслі вікової структури.**
   ...
   Найбільший з них, $$\lambda_L$$ &mdash; темп росту популяції, а відповідний йому (як власному числу) власний вектор $$x_L$$ &mdash; вектор стійкої структури популяції, тобто $$\frac{x(t)}{\|x(t)\|_1} \to \frac{x_L}{\|x_L\|_1}$$ при $$t \to \infty$$, де ділення на $$\|\cdot\|_1$$ відбувається для переходу до відсоткового складу.
