...
13. **Попит та пропозиція. Модель Маршала. Ринкова рівновага.**
    ...
    Тоді з умови $$Q_s = Q_d$$ знаходимо $$P^\star = \frac{c - a}{b + d}$$, $$Q^\star = \frac{a d + b c}{b + d}$$.
...
15. **Еластичність попиту та пропозиції. Три типи рівноваги ринку.**
    ...
    Зрозуміло, що взагалі кажучи, еластичність попиту за ціною &mdash; число від'ємне, тому класифікацію проводять за значенням $$|E_d^p|$$:

    1. $$\left|E_d^p\right| < 1$$ &mdash; попит називається не еластичним;
    2. $$\left|E_d^p\right| = 1$$ &mdash; попит називається еластичним;
    3. $$\left|E_d^p\right| > 1$$ &mdash; попит називається наделастичним.
    ...
    1. $$\left|E_s^p\right| < 1$$ &mdash; пропозиція називається не еластичною;
    2. $$\left|E_s^p\right| = 1$$ &mdash; пропозиція називається еластичною;
    3. $$\left|E_s^p\right| > 1$$ &mdash; пропозиція називається наделастичною.

    На базі еластичностей можна проводити аналіз стабільності рівноваги:

    1. $$\left|E_d\right| > E_s$$ &mdash; стабільна динамічна рівновага;
    2. $$\left|E_d\right| = E_s$$ &mdash; квазістабільна динамічна рівновага;
    3. $$\left|E_d\right| < E_s$$ &mdash; не стабільна динамічна рівновага.
