...
1. Якщо $$0 < b/d < 1$$, то при $$t \to \infty$$ маємо $$\left(b/d\right)^t \to 0$$, тому $$\lim_{t \to \infty} P_t = P^\star$$ &mdash; так звана стабільна динамічна рівновага.
2. Якщо $$b/d = 1$$, то при $$t \to \infty$$ маємо $$\left(b/d\right)^t \to 1$$ &mdash; так звана квазістабільна динамічна рівновага за якої відбуваються осциляції довкола рівноваги.
3. Якщо $$1 < b/d$$, то при $$t \to \infty$$ маємо $$\left(b/d\right)^t \to \infty$$ &mdash; так звана нестабільна динамічна рівновага.
