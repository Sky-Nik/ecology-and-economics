...
15. **Еластичність попиту та пропозиції. Три типи рівноваги ринку.**
    ...
    1. $$\left\mid E_d^p \mid\right < 1$$ &mdash; попит називається не еластичним;
    2. $$\left\mid E_d^p \mid\right = 1$$ &mdash; попит називається еластичним;
    3. $$\left\mid E_d^p \mid\right > 1$$ &mdash; попит називається наделастичним.
    ...
    1. $$\mid E_d \mid > E_s$$ &mdash; стабільна динамічна рівновага;
    2. $$\mid E_d \mid = E_s$$ &mdash; квазістабільна динамічна рівновага;
    3. $$\mid E_d \mid < E_s$$ &mdash; не стабільна динамічна рівновага.
