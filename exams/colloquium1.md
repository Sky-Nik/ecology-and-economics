...
1. [Найпростіші неперервні математичні моделі динаміки популяцій.](#найпростіші-неперервні-математичні-моделі-динаміки-популяцій)
2. [Найпростіші дискретні математичні моделі динаміки популяцій.](#найпростіші-дискретні-математичні-моделі-динаміки-популяцій)
3. [Модель Леслі вікової структури.](#модель-леслі-вікової-структури)
4. [Модель Вольтерра. Постановка. Типи стаціонарних точок.](#модель-вольтерра-постановка-типи-стаціонарних-точок)
5. [Модель Лотки-Вольтерра. Постановка. Типи стаціонарних точок.](#модель-лотки-вольтерра-постановка-типи-стаціонарних-точок)
6. [Класична модель епідемії.](#класична-модель-епідемії)
7. [Модель епідемії з врахуванням запізнення.](#модель-епідемії-з-врахуванням-запізнення)
8. [Задача про знищення шкідників за скінченний час.](#задача-про-знищення-шкідників-за-скінченний-час)
9. [Задача про розвиток риби у ставку.](#задача-про-розвиток-риби-у-ставку)
10. [Задача про вилов риби у ставку з врахуванням квоти на вилов при $$р = 1/4$$.](#задача-про-вилов-риби-у-ставку-з-врахуванням-квоти-на-вилов-при-р--14)
11. [Задача про вилов риби у ставку з врахуванням квоти на вилов при $$р < 1/4$$.](#задача-про-вилов-риби-у-ставку-з-врахуванням-квоти-на-вилов-при-р--14-1)
12. [Задача про вилов риби у ставку з врахуванням квоти на вилов при $$р > 1/4$$.](#задача-про-вилов-риби-у-ставку-з-врахуванням-квоти-на-вилов-при-р--14-2)
13. [Попит та пропозиція. Модель Маршала. Ринкова рівновага.](#попит-та-пропозиція-модель-маршала-ринкова-рівновага)
14. [Павутиноподібна модель. Три типи рівноваги ринку.](#павутиноподібна-модель-три-типи-рівноваги-ринку)
15. [Еластичність попиту та пропозиції. Три типи рівноваги ринку.](#еластичність-попиту-та-пропозиції-три-типи-рівноваги-ринку)
16. [Еластичність попиту та пропозиції. Виручка продавців.](#еластичність-попиту-та-пропозиції-виручка-продавців)

### _І навіть відповіді!_

#### **Найпростіші неперервні математичні моделі динаміки популяцій.**
...
#### **Найпростіші дискретні математичні моделі динаміки популяцій.**
...
#### **Модель Вольтерра. Постановка. Типи стаціонарних точок.**
...
#### **Модель Лотки-Вольтерра. Постановка. Типи стаціонарних точок.**
...
#### **Модель епідемії з врахуванням запізнення.**
...
#### **Задача про знищення шкідників за скінченний час.**
...
#### **Задача про розвиток риби у ставку.**
...
#### **Задача про вилов риби у ставку з врахуванням квоти на вилов при $$р = 1/4$$.**

Стаціонарні точка єдина, $$n^\star = \frac{1}{2}$$, причому вона є напівстійкою: при $$n_0 > n^\star$$ маємо $$n \to n^\star$$, а при $$n_0 < n^\star$$ маємо вимирання популяції риби.
...
#### **Попит та пропозиція. Модель Маршала. Ринкова рівновага.**

_Обсяг попиту_ &mdash; кількість товару, яку споживач має намір купити за конкретною ціною, позначається $$Q_d(P)$$ (eng. _demand_ ). У нормальних людей $$\frac{\mathrm{d}Q_d}{\mathrm{d}P} < 0$$, тобто попит є монотонно спадною функцією (за більшу ціну люди готові купити менше товару). Але це у нормальних людей, _а у нас чомусь Apple продається краще ніж Xiaomi_ .
...
Будь-який споживач має свій власний, _індивідуальний_  попит на різні товри, аналізувати який &mdash; невдячна справа, надто багато всього необхідно враховувати, тому зазвичай аналізують _ринковий_ попит &mdash; сукупний попит усіх індивідів-споживачів, який здебільшого набагато краще описується в залежності лише від ціни.

_Обсяг пропозиції_ &mdash; кількість товару, яку фірма виробляє/реалізує за певною ціною, позначається $$Q_s(P)$$ (eng. _supply_ ). У нормальних людей $$\frac{\mathrm{d}Q_s}{\mathrm{d}P} > 0$$, тобто пропозиція є монотонно зростаючою функцією.
...
Щоб споживач міг купити товар, а виробник &mdash; його продати, має існувати такий рівень цін та обсяг продажу що буде задовольняти обох гравців, тобто _ринкова рівновага_ &mdash; такий стан ринку $$(P^\star, Q^\star)$$, коли $$Q_d(P^\star) = Q^\star = Q_s(P^\star)$$.
...
#### **Павутиноподібна модель. Три типи рівноваги ринку.**
...
Можна показати, що $$P^\star - P_t = \left( - \frac{b}{d} \right)^t \cdot (P^\star - P_0)$$, звідки безпосередньо випливає класифікація типів рівноваги:

1. Якщо $$0 < \frac{b}{d} < 1$$, то при $$t \to \infty$$ маємо $$\left(\frac{b}{d}\right)^t \to 0$$, тому $$\lim_{t \to \infty} P_t = P^\star$$ &mdash; так звана стабільна динамічна рівновага.
2. Якщо $$\frac{b}{d} = 1$$, то при $$t \to \infty$$ маємо $$\left(\frac{b}{d}\right)^t \to 1$$ &mdash; так звана квазістабільна динамічна рівновага за якої відбуваються осциляції довкола рівноваги.
3. Якщо $$1 < \frac{b}{d}$$, то при $$t \to \infty$$ маємо $$\left(\frac{b}{d}\right)^t \to \infty$$ &mdash; так звана нестабільнадинамічна рівновага.

#### **Еластичність попиту та пропозиції. Три типи рівноваги ринку.**
...
або ж, у скороченому вигляді $$E_d^p = \frac{\Delta Q_d}{\Delta P} \cdot \frac{P_1}{Q_1}$$, що, очевидно, пішло від неперервного аналогу $$E_d^p = \frac{\mathrm{d} Q_d}{\mathrm{d} P} \cdot \frac{P_1}{Q_1}$$.

Зрозуміло, що взагалі кажучи, еластичність попиту за ціною &mdash; число від'ємне, тому класифікацію проводять за значенням $$\mid E_d^p \!\mid\, $$:

- $$\mid E_d^p \!\mid\, < 1$$ &mdash; попит називається не еластичним;
- $$\mid E_d^p \!\mid\, = 1$$ &mdash; попит називається еластичним;
- $$\mid E_d^p \!\mid\, > 1$$ &mdash; попит називається наделастичним.
...
- $$\mid E_d \!\mid\, > E_s$$ &mdash; стабільна динамічна рівновага;
- $$\mid E_d \!\mid\, = E_s$$ &mdash; квазістабільна динамічна рівновага;
- $$\mid E_d \!\mid\, < E_s$$ &mdash; не стабільна динамічна рівновага.

#### **Еластичність попиту та пропозиції. Виручка продавців.**
...
- якщо $$\mid E_d \!\mid\, > 1$$, тобто попит еластичний, то:
  - зниження ціни веде до зростання виручки;
  - підвищення ціни веде до зниження виручки.
- якщо $$\mid E_d \!\mid\, < 1$$, тобто попит ке еластичний, то:
