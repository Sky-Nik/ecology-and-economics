...
15. **Еластичність попиту та пропозиції. Три типи рівноваги ринку.**
    ...
    1. $$\mid E_d^p \mid < 1$$ &mdash; попит називається не еластичним;
    2. $$\mid E_d^p \mid = 1$$ &mdash; попит називається еластичним;
    3. $$\mid E_d^p \mid > 1$$ &mdash; попит називається наделастичним.
