...
Через те, що однакові обсяги виробництва продукції можуть забезпечуватися внаслідок різних комбінацій обсягів ресурсів з різною вартістю, стає доцільним розгялядати _виробничу функцію_: $$Q(x)$$. 
