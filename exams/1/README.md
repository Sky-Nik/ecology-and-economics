...
Стаціонарні точка єдина, $$n^\star = 1/2$$, причому вона є напівстійкою: при $$n_0 > n^\star$$ маємо <nobr>$$n \to n^\star$$,</nobr> а при $$n_0 < n^\star$$ маємо вимирання популяції риби.
