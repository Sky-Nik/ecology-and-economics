...
_Не радимо списувати з цих відповідей слово в слово, адже це легко перевіряється проханням усно повторити Вашу відповідь на співбесіді після модуля або на заліку_/_іспиті._
...
Стаціонарні точка єдина, $$n^\star = 1/2$$, причому вона є напівстійкою: при $$n_0 > n^\star$$ <nobr>маємо $$n \to n^\star$$,</nobr> а при $$n_0 < n^\star$$ маємо вимирання популяції риби.
